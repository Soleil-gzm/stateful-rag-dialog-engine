...
from src.config.arguments import CustomizedArguments          # ← 改了
from src.component.template import template_dict
from src.component.structure_frontend_v2 import Pathway, Module
